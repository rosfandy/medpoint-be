...
type DoctorSchedules struct {
	...
	DoctorId    string    `json:"doctor_id,omitempty" column:"name:doctor_id;type:uuid;nullable;default:gen_random_uuid()"`
	DayOfWeek   string    `json:"day_of_week,omitempty" column:"name:day_of_week;type:varchar;nullable"`
	StartTime   string    `json:"start_time,omitempty" column:"name:start_time;type:timez;nullable"`
	EndTime     string    `json:"end_time,omitempty" column:"name:end_time;type:timez;nullable"`
